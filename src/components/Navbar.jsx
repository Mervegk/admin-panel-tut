        ...
        <div className='flex justify-between p-2 md:mx-6 relative'>
            ...
            <div className='flex'>
                <NavButton title="Cart" customFunc={() => handleClick('cart')}
                    color="blue" icon={<FiShoppingCart />} dotColor="blue" />
                <NavButton title="Chat" customFunc={() => handleClick('chat')}
                    color="blue" icon={<BsChatLeft />} dotColor="blue" />
                ...
                <TooltipComponent content='Profile' position='BottomCenter'>
                    <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg'
                        ...
                        <div><img className='rounded-full w-8 h-8' src={avatar} alt='avatar'></img></div>
                        <p><span className='text-gray-400 text-14'>Hi, </span><span className='text-gray-400 font-bold ml-1 text-14'>Michael</span></p>
